...
Player::Player(float width, float height, float x, float y, sf::Texture& texture_sheet)
{
	...
	this->animationComponent->addAnimation("IDLE_LEFT",  5.f, 0, 1, 4, 1, 48, 48);
	this->animationComponent->addAnimation("IDLE_RIGHT", 5.f, 0, 2, 4, 2, 48, 48);
	this->animationComponent->addAnimation("IDLE_UP",    5.f, 0, 3, 4, 3, 48, 48);
	

	//MOVING
	this->animationComponent->addAnimation("WALK_DOWN",  1.5f, 0, 4, 7, 4, 48, 48);
	...
	this->animationComponent->addAnimation("WALK_UP",    1.5f, 0, 7, 7, 7, 48, 48);
